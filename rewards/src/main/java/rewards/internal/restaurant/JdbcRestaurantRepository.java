 ...
 */
public class JdbcRestaurantRepository extends SimpleJdbcDaoSupport implements RestaurantRepository {
	...
	public Restaurant findByMerchantNumber(String merchantNumber) {
		...
		return getSimpleJdbcTemplate().queryForObject(sql, rowMapper, merchantNumber);
	}
