...
public class RewardController {
	...
	/* TODO 07: Annotate with @RequestMapping to be invoked for GETs to /rewards/{confirmationNumber} */
	
	public Reward getReward(@PathVariable String confirmationNumber) {
	 
	/* TODO 08: Return the mapped Reward with the given confirmationNumber
	...
	/* TODO 11: Execute the following tasks: 
